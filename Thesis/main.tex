...
\vspace{24pt}
 ...
 % THESIS TITTLE
        \fontsize{17pt}{0pt}{\fontfamily{qag}\selectfont{} \textbf{DỰ BÁO PHỤ TẢI ĐIỆN NGẮN HẠN DỰA TRÊN MÔ HÌNH ESN-ELM}}
\vspace{18pt}
...
\hspace{-1cm}Họ và tên sinh viên: Nguyễn Anh Dũng\\Khóa: K67 \hfill Trường: Điện -- Điện tử \hfill Ngành: Kỹ thuật Điều khiển và Tự động hóa\\
    
    % Thay các dấu chấm (\ldots) dưới đây bằng nội dung
    
    \hspace{-1cm}\textit{1. Tên đề tài}\\
             DỰ BÁO PHỤ TẢI ĐIỆN NGẮN HẠN DỰA TRÊN MÔ HÌNH ESN-ELM \\[0.2cm]
    \textit{2. Nội dung đề tài}\\
            ...
            CHƯƠNG 4: XÂY DỰNG MÔ HÌNH DỰ BÁO PHỤ TẢI ĐIỆN ESN-ELM\\[0.1cm]
            CHƯƠNG 5: KẾT QUẢ MÔ PHỎNG VÀ ĐÁNH GIÁ\\[0.1cm]
            CHƯƠNG 6: KẾT LUẬN VÀ HƯỚNG PHÁT TRIỂN \\[0.2cm]
    \textit{3. Thời gian giao đề tài: 15/03/2026} \\[0.2cm]
...
\section*{LỜI CẢM ƠN}
    \thispagestyle{empty}
Trước hết, em xin bày tỏ lòng biết ơn sâu sắc tới PGS.TS.Trần Thị Thảo, đã tận tình hướng dẫn, định hướng nghiên cứu và góp ý cho em trong suốt quá trình thực hiện đồ án tốt nghiệp. Những nhận xét và chỉ dẫn của cô là cơ sở quan trọng để em hoàn thiện nội dung nghiên cứu, phương pháp thực hiện cũng như cách trình bày kết quả của đồ án.

Em xin gửi lời cảm ơn tới các thầy cô Trường Điện - Điện tử, Đại học Bách khoa Hà Nội đã truyền đạt cho em những kiến thức nền tảng về kỹ thuật điều khiển, tự động hóa, hệ thống điện và tư duy phân tích kỹ thuật trong suốt quá trình học tập. Đây là cơ sở quan trọng giúp em tiếp cận bài toán dự báo phụ tải điện, cũng như triển khai các phương pháp mô hình hóa và xử lý dữ liệu phục vụ cho đồ án tốt nghiệp.

Em cũng xin cảm ơn gia đình, bạn bè và những người đã luôn động viên, hỗ trợ em trong quá trình học tập và thực hiện đồ án. Sự giúp đỡ và khích lệ đó là nguồn động lực lớn để em hoàn thành công việc trong thời gian vừa qua.

Do giới hạn về thời gian, kinh nghiệm nghiên cứu và năng lực thực hiện, đồ án không tránh khỏi những thiếu sót. Em kính mong nhận được sự góp ý của các thầy cô để đồ án được hoàn thiện hơn.

\vspace{6pt}
    \hspace{7cm}Hà Nội, ngày 16 tháng 06 năm 2026
        
        \hspace{8.6cm} Sinh viên thực hiện      % command '\hspace' used to line indents

\vspace{2cm}
    \hspace{8.8cm}\textbf{Nguyễn Anh Dũng} % change name
